...
import static slayTheMiko.SlayTheMikoMod.*;
...
public class Yoimiya extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass YOIMIYA;
        @SpireEnum(name = "SLAY_THE_MIKO_ORANGE_COLOR") // These two HAVE to have the same absolutely identical name.
...
//        e.setTime(e.getEndTime() * MathUtils.random());
    ...
    public AbstractPlayer newInstance() {
        return new Yoimiya(name, chosenClass);
    }
