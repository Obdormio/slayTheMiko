...
@SpireInitializer
public class SlayTheMikoMod implements
        EditCardsSubscriber,
    ...
    private static final String MODNAME = "SlayTheMiko";
    private static final String AUTHOR = "Lidafan"; // And pretty soon - You!
    private static final String DESCRIPTION = "Slay the miko";

    // =============== INPUT TEXTURE LOCATION =================

    // Colors (RGB)
    // Character Color
    public static final Color ORANGE = CardHelper.getColor(255.0f, 90.0f, 0.0f);
    ...
    private static final String ATTACK_YOIMIYA = "slayTheMikoResources/images/512/bg_attack_yoimiya.png";
    private static final String SKILL_YOIMIYA = "slayTheMikoResources/images/512/bg_skill_yoimiya.png";
    private static final String POWER_YOIMIYA = "slayTheMikoResources/images/512/bg_power_yoimiya.png";

    private static final String ENERGY_ORB_YOIMIYA = "slayTheMikoResources/images/512/card_yoimiya_orb.png";
    private static final String CARD_ENERGY_ORB = "slayTheMikoResources/images/512/card_small_orb.png";

    private static final String ATTACK_YOIMIYA_PORTRAIT = "slayTheMikoResources/images/1024/bg_attack_yoimiya.png";
    private static final String SKILL_YOIMIYA_PORTRAIT = "slayTheMikoResources/images/1024/bg_skill_yoimiya.png";
    private static final String POWER_YOIMIYA_PORTRAIT = "slayTheMikoResources/images/1024/bg_power_yoimiya.png";
    ...
    public SlayTheMikoMod() {
        logger.info("Subscribe to BaseMod hooks");

        BaseMod.subscribe(this);

        setModID("slayTheMiko");

        logger.info("Done subscribing");

        logger.info("Creating the color " + Yoimiya.Enums.COLOR_ORANGE.toString());

        BaseMod.addColor(Yoimiya.Enums.COLOR_ORANGE, ORANGE, ORANGE, ORANGE,
                ORANGE, ORANGE, ORANGE, ORANGE,
                ATTACK_YOIMIYA, SKILL_YOIMIYA, POWER_YOIMIYA, ENERGY_ORB_YOIMIYA,
                ATTACK_YOIMIYA_PORTRAIT, SKILL_YOIMIYA_PORTRAIT, POWER_YOIMIYA_PORTRAIT,
                ENERGY_ORB_YOIMIYA_PORTRAIT, CARD_ENERGY_ORB);
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = SlayTheMikoMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = SlayTheMikoMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = SlayTheMikoMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public void receivePostInitialize() {
        ...
        ConsoleCommand.addCommand("miko", MikoCommand.class);
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(PlaceholderPotion.class, PLACEHOLDER_POTION_LIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, PlaceholderPotion.POTION_ID, Yoimiya.Enums.YOIMIYA);
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new PlaceholderRelic(), Yoimiya.Enums.COLOR_ORANGE);
        BaseMod.addRelicToCustomPool(new BottledPlaceholderRelic(), Yoimiya.Enums.COLOR_ORANGE);
        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), Yoimiya.Enums.COLOR_ORANGE);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("SlayTheMiko") // ${project.artifactId}
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(CardStrings.class,
                getModID() + "Resources/localization/zhs/DefaultMod-Card-Strings.json");

        // PowerStrings
        BaseMod.loadCustomStringsFile(PowerStrings.class,
                getModID() + "Resources/localization/zhs/DefaultMod-Power-Strings.json");

        // RelicStrings
        BaseMod.loadCustomStringsFile(RelicStrings.class,
                getModID() + "Resources/localization/zhs/DefaultMod-Relic-Strings.json");

        // Event Strings
        BaseMod.loadCustomStringsFile(EventStrings.class,
                getModID() + "Resources/localization/zhs/DefaultMod-Event-Strings.json");

        // PotionStrings
        BaseMod.loadCustomStringsFile(PotionStrings.class,
                getModID() + "Resources/localization/zhs/DefaultMod-Potion-Strings.json");

        // CharacterStrings
        BaseMod.loadCustomStringsFile(CharacterStrings.class,
                getModID() + "Resources/localization/zhs/DefaultMod-Character-Strings.json");

        // OrbStrings
        BaseMod.loadCustomStringsFile(OrbStrings.class,
                getModID() + "Resources/localization/zhs/DefaultMod-Orb-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(getModID() + "Resources/localization/zhs/DefaultMod-Keyword-Strings.json").readString(String.valueOf(StandardCharsets.UTF_8));
