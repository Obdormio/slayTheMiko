...
public class YoimiyaAsyncPower extends AbstractDynamicCard {
    ...
    public static final String ID = SlayTheMikoMod.makeID(YoimiyaAsyncPower.class.getSimpleName());
