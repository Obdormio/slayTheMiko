...
import slayTheMiko.patches.relics.BottledPlaceholderField;
import slayTheMiko.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static slayTheMiko.SlayTheMikoMod.makeRelicOutlinePath;
import static slayTheMiko.SlayTheMikoMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = SlayTheMikoMod.makeID("BottledPlaceholderRelic");
